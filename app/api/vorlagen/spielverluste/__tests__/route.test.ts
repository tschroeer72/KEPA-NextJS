...
describe('GET /api/vorlagen/spielverluste', () => {
    it('sollte ein Spielverluste PDF generieren', async () => {
        const req = new NextRequest('http://localhost/api/vorlagen/spielverluste');
