...
describe('GET /api/vorlagen/mitgliederliste', () => {
    it('sollte ein Mitgliederliste PDF generieren', async () => {
        const req = new NextRequest('http://localhost/api/vorlagen/mitgliederliste');
