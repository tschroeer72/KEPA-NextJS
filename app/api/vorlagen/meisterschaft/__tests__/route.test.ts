...
describe('GET /api/vorlagen/meisterschaft', () => {
    it('sollte ein Meisterschaft PDF generieren', async () => {
        const req = new NextRequest('http://localhost/api/vorlagen/meisterschaft');
