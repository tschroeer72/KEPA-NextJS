...
describe('GET /api/vorlagen/6-tage-rennen', () => {
    it('sollte ein 6-Tage-Rennen PDF generieren', async () => {
        const req = new NextRequest('http://localhost/api/vorlagen/6-tage-rennen');
