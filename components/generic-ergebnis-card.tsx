      ...
      case "9er-ratten-kranz8":
        ...
        return (
          <Table>
            ...
            <TableBody>
              {(() => {
                let lastSpieltag: string | number | null = null;
                let isOdd = false;
                return data.neunerRatten.map((item, i: number) => {
                  if (item.Spieltag !== lastSpieltag) {
                    isOdd = !isOdd;
                    lastSpieltag = item.Spieltag;
                  }
                  return (
                    <TableRow key={i} className={isOdd ? "bg-muted/50" : ""}>
                      <TableCell>{item.Spieltag}</TableCell>
          ...
          <Table>
            ...
            <TableBody>
              {(() => {
                let lastSpieltag: string | number | null = null;
                let isOdd = false;
                return data.sechsTageRennen.map((item, i: number) => {
                  if (item.Spieltag !== lastSpieltag) {
                    isOdd = !isOdd;
                    lastSpieltag = item.Spieltag;
                  }
          ...
          <Table>
            ...
            <TableBody>
              {(() => {
                let lastSpieltag: string | number | null = null;
                let isOdd = false;
                return data.pokal.map((item, i: number) => {
                  if (item.Spieltag !== lastSpieltag) {
                    isOdd = !isOdd;
                    lastSpieltag = item.Spieltag;
                  }
          ...
          <Table>
            ...
            <TableBody>
              {(() => {
                let lastSpieltag: string | number | null = null;
                let isOdd = false;
                return data.sargkegeln.map((item, i: number) => {
                  if (item.Spieltag !== lastSpieltag) {
                    isOdd = !isOdd;
                    lastSpieltag = item.Spieltag;
                  }
          ...
          <Table>
            ...
            <TableBody>
              {(() => {
                let lastSpieltag: string | number | null = null;
                let isOdd = false;
                return data.meisterschaft.map((item, i: number) => {
                  if (item.Spieltag !== lastSpieltag) {
                    isOdd = !isOdd;
                    lastSpieltag = item.Spieltag;
                  }
          ...
          <Table>
            ...
            <TableBody>
              {(() => {
                let lastSpieltag: string | number | null = null;
                let isOdd = false;
                return data.blitztunier.map((item, i: number) => {
                  if (item.Spieltag !== lastSpieltag) {
                    isOdd = !isOdd;
                    lastSpieltag = item.Spieltag;
                  }
          ...
          <Table>
            ...
            <TableBody>
              {(() => {
                let lastSpieltag: string | number | null = null;
                let isOdd = false;
                return data.kombimeisterschaft.map((item, i: number) => {
                  if (item.Spieltag !== lastSpieltag) {
                    isOdd = !isOdd;
                    lastSpieltag = item.Spieltag;
                  }
